...
<div class="page_header">
	<div>
		...
		<span class="main-text">Layanan</span>
	</div>
</div>
<!-- /pageheader -->
		...
		<div class="panel-heading">
			<h3 class="panel-title">
				<div class="filter-block pull-right">
					...
					&nbsp;
					<a href="layanan-add.php" class="btn btn-primary pull-right" style="height:40px;"><i class="fa fa-plus-circle fa-lg"></i> Tambah Layanan</a>
				</div>				
			</h3>
		</div>
